...
{!! Form::open(['route' => ['leases.pet.store',$property,$apartment,$lease],'method' => 'post','id' => 'petrent','class' => 'form-horizontal']) !!}
	<div class="modal-body">
		<div class="row">	
			<div class="col-sm-12">
                <div class="form-group @if($errors->first('month_pet_rent')) has-error @endif">
                    {!! Form::label('month_pet_rent','Set Monthly Pet Rent:',['for' => 'month_pet_rent','class' => 'col-sm-4 control-label']) !!}
                    <div class="col-sm-4">
                            {!! Form::text('month_pet_rent',null,['id' => 'month_pet_rent','class' => 'form-control']) !!}
