                    ...
                    <div class="table-responsive">
                        <table id="deposit" class="table table-striped table-condensed ledger" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $t->fullname }}</td>
                                    <td align="right" class="text-right">{{ money_format('%.2n',$lease->payments()->where('tenant_id',$t->id)->where('payment_type','Deposit')->sum('amount')) }}</td>
                                </tr>
                                @endforeach
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td align="right" class="text-right"><strong>{{ money_format('%.2n',$lease->payments()->where('payment_type','Deposit')->sum('amount')) }}</strong></td>
                                </tr>
                                <tr>
