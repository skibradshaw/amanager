    ...
    <div class="form-group @if($errors->first('paid_date')) has-error @endif">
        ...
        <div class="col-sm-4">
				{!! Form::text('paid_date',(isset($payment))? $payment->paid_date->format('n/j/Y'):\Carbon\Carbon::now()->format('n/j/Y'),['id' => 'paid_date','class' => 'datepicker form-control','placeholder' => 'mm/dd/yyyy','style' => 'position: relative; z-index: 100000;']) !!}
